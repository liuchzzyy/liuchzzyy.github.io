...
export default function Footer({ lastUpdatedEn, lastUpdatedZh }: FooterProps) {
  ...
  const lastUpdatedLabel = language === 'zh' ? '最后更新：' : 'Last updated: ';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
          <p className="text-xs text-neutral-500">
            {lastUpdatedLabel}{lastUpdated || new Date().toLocaleDateString(language === 'zh' ? 'zh-CN' : 'en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
          </p>
